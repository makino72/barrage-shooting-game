...
ENEMY::ENEMY(float x,float y,float in_time,float stop_time,float shot_time,float out_time,
	...
	switch(e_type){
	case 0:
		gh=LoadGraph("素材/ザコ敵0.png");
		break;
	case 1:
		gh=LoadGraph("素材/ボス1.png");
		break;
	}
	this->x=x;
	this->y=y;
	...
	if(shot_type==1){
		temp=LoadGraph("素材/eshot1.png");
	    GetGraphSize(temp,&w,&h);
	}else if(shot_type==2){
		temp=LoadGraph("素材/eshot2.png");
	    GetGraphSize(temp,&w,&h);
	}else if(shot_type==0){
		temp=LoadGraph("素材/eshot3.png");
	    GetGraphSize(temp,&w,&h);
	}else if(shot_type==3){
		temp =LoadGraph("素材/star01_BL.png");
		temp1=LoadGraph("素材/star01_GR.png");
		temp2=LoadGraph("素材/star01_OR.png");
		temp3=LoadGraph("素材/star01_RE.png");
		w=20,h=20;
	}
